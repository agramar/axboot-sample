package kr.co.agramar.controllers;

import kr.co.agramar.domain.sample.child.ChildSample;
import kr.co.agramar.domain.sample.child.ChildSampleService;
import kr.co.agramar.domain.sample.child.ChildSampleVO;
import kr.co.agramar.domain.sample.parent.ParentSample;
import kr.co.agramar.domain.sample.parent.ParentSampleService;
import kr.co.agramar.domain.sample.parent.ParentSampleVO;
