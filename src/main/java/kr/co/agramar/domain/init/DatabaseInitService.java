package kr.co.agramar.domain.init;

import kr.co.agramar.domain.code.CommonCode;
import kr.co.agramar.domain.code.CommonCodeService;
import kr.co.agramar.domain.program.Program;
import kr.co.agramar.domain.program.ProgramService;
import kr.co.agramar.domain.program.menu.Menu;
import kr.co.agramar.domain.program.menu.MenuService;
import kr.co.agramar.domain.user.User;
import kr.co.agramar.domain.user.UserService;
import kr.co.agramar.domain.user.auth.UserAuth;
import kr.co.agramar.domain.user.auth.UserAuthService;
import kr.co.agramar.domain.user.auth.menu.AuthGroupMenu;
import kr.co.agramar.domain.user.auth.menu.AuthGroupMenuService;
import kr.co.agramar.domain.user.role.UserRole;
import kr.co.agramar.domain.user.role.UserRoleService;
